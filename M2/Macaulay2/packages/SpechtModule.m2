...
multidoc  ///    
 Node
  ...
  Description
   Text    
    ...
    And finally methods for calculating the secondary invariants described abovey.
  Caveat
 ...
 Node
  ...
  Description
   Text
       The size is calculate as the sum of the numbers in the partition associated to the tableau
   Example
	y = youngTableau(new Partition from {2,1,1,1},{2,0,1,4,3})
	size y
